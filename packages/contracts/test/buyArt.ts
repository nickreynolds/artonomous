...
//       await expect(artonomous.buyArt({ value: 1000000000000 })).to.eventually.be.fulfilled(
...
//       await expect(artonomous.buyArt({ value: 2000000000000 })).to.eventually.be.fulfilled(
...
//       await expect(artonomous.buyArt({ value: 100000000000 })).to.eventually.be.rejectedWith(
//         "revert",
//         "should not have allowed user to buy art without sending enough ETH",
//       );
//     });
...
//       await advanceEvmTime(86401); // just over 24 hours
//       await expect(artonomous.buyArt({ value: 1000000000000 })).to.eventually.be.rejectedWith(
//         "revert",
//         "should not have allowed user to buy art after end of auction and without sending enough ETH",
//       );
//     });
